...
const HeroGandhiNagar = () => {
  ...
  return (
    <section className="relative pt-35 pb-20 bg-gradient-to-r from-blue-600 to-purple-700 text-white min-h-screen">
...
export default HeroGandhiNagar;
