...
export default function PopupFormMumbai({
  ...
  const handleSubmit = async (e) => {
    ...
    const formUrl =
      "https://docs.google.com/forms/d/e/1FAIpQLScnWeHlALSyaA6cCVIdhxvAzQm_byAsqBdnxFeZDqtDJdBIlQ/formResponse";

    const formDataToSend = new FormData();
    formDataToSend.append("entry.921639443", formData.name);
    formDataToSend.append("entry.957573307", formData.city);
    formDataToSend.append("entry.1504722312", formData.phone);
