...
const pillars = [
  {
    ...
    description:
      "Traditional real estate requires crores. ASW gives you exclusive access to 1 lac sq. ft. of prime office space in Gurgaon, Delhi, and Noida to market as your own.",
